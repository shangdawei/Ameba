...
osMessageQueueId_t svcRtxMessageQueueNew( uint32_t msg_count, uint32_t msg_size,
...
osStatus_t svcRtxMessageQueuePut( osMessageQueueId_t mq_id, const void *msg_ptr, uint8_t msg_prio,
  uint32_t timeout )
{
  os_message_queue_t *mq = (os_message_queue_t *) mq_id;
  os_message_t *msg;
...
osStatus_t svcRtxMessageQueueGet( osMessageQueueId_t mq_id, void *msg_ptr, uint8_t *msg_prio,
  uint32_t timeout )
{
  os_message_queue_t *mq = (os_message_queue_t *) mq_id;
  os_message_t *msg;
...
/// \note API identical to osMessageQueuePut
__STATIC_INLINE
osStatus_t isrRtxMessageQueuePut( osMessageQueueId_t mq_id, const void *msg_ptr, uint8_t msg_prio,
  uint32_t timeout )
{
  os_message_queue_t *mq = (os_message_queue_t *) mq_id;
  os_message_t *msg;
...
/// \note API identical to osMessageQueueGet
__STATIC_INLINE
osStatus_t isrRtxMessageQueueGet( osMessageQueueId_t mq_id, void *msg_ptr, uint8_t *msg_prio,
  uint32_t timeout )
{
  os_message_queue_t *mq = (os_message_queue_t *) mq_id;
  os_message_t *msg;
