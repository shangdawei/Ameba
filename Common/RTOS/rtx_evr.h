...
extern void EvrRtxMemoryBlockInit( osRtxMpInfo_t *mp_info, uint32_t block_count,
...
extern void EvrRtxThreadEnumerate( osThreadId_t *thread_array, uint32_t array_items,
  uint32_t count );
#else
...
extern void EvrRtxTimerNew( osTimerFunc_t func, osTimerType_t type, void *argument,
...
extern void EvrRtxEventFlagsWait( osEventFlagsId_t ef_id, int32_t flags, uint32_t options,
  uint32_t timeout );
#else
...
extern void EvrRtxEventFlagsWaitPending( osEventFlagsId_t ef_id, int32_t flags, uint32_t options,
  uint32_t timeout );
#else
...
extern void EvrRtxEventFlagsWaitCompleted( osEventFlagsId_t ef_id, int32_t flags, uint32_t options,
  int32_t event_flags );
#else
...
extern void EvrRtxEventFlagsWaitNotCompleted( osEventFlagsId_t ef_id, int32_t flags,
  uint32_t options );
#else
...
extern void EvrRtxSemaphoreNew( uint32_t max_count, uint32_t initial_count,
...
extern void EvrRtxMemoryPoolNew( uint32_t block_count, uint32_t block_size,
...
extern void EvrRtxMessageQueueNew( uint32_t msg_count, uint32_t msg_size,
...
extern void EvrRtxMessageQueuePut( osMessageQueueId_t mq_id, const void *msg_ptr, uint8_t msg_prio,
  uint32_t timeout );
#else
...
extern void EvrRtxMessageQueuePutPending( osMessageQueueId_t mq_id, const void *msg_ptr,
  uint32_t timeout );
#else
...
extern void EvrRtxMessageQueueGet( osMessageQueueId_t mq_id, void *msg_ptr, uint8_t *msg_prio,
  uint32_t timeout );
#else
...
extern void EvrRtxMessageQueueGetPending( osMessageQueueId_t mq_id, void *msg_ptr,
  uint32_t timeout );
#else
