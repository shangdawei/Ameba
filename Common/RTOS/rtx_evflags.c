...
int32_t svcRtxEventFlagsWait( osEventFlagsId_t ef_id, int32_t flags, uint32_t options,
  uint32_t timeout )
{
  os_event_flags_t *ef = (os_event_flags_t *) ef_id;
...
/// \note API identical to osEventFlagsWait
__STATIC_INLINE
int32_t isrRtxEventFlagsWait( osEventFlagsId_t ef_id, int32_t flags, uint32_t options,
  uint32_t timeout )
{
  os_event_flags_t *ef = (os_event_flags_t *) ef_id;
  int32_t event_flags;
...
/// Wait for one or more Event Flags to become signaled.
int32_t osEventFlagsWait( osEventFlagsId_t ef_id, int32_t flags, uint32_t options,
  uint32_t timeout )
{
