...
DBG_8195A_ADC_LVL(HAL_ADC_LVL,"REG_ADC_CONTROL:%x\n", HAL_ADC_READ32( REG_ADC_CONTROL ));
    ...
    switch (AdcTempIdx) {
        case ADC0_SEL:
            AdcTempDat  =   HAL_ADC_READ32( REG_ADC_COMP_VALUE_L );AdcTempDat  &=  ~(BIT_ADC_COMP_TH_0( 0xFFFF ));
            AdcTempDat  |=  BIT_CTRL_ADC_COMP_TH_0(
  pHalAdcInitData->ADCCompTD );HAL_ADC_WRITE32( REG_ADC_COMP_VALUE_L, AdcTempDat );break;

        case ADC1_SEL:
            AdcTempDat  =   HAL_ADC_READ32(
  REG_ADC_COMP_VALUE_L );AdcTempDat  &=  ~(BIT_ADC_COMP_TH_1( 0xFFFF ));
            AdcTempDat  |=  BIT_CTRL_ADC_COMP_TH_1(
  pHalAdcInitData->ADCCompTD );HAL_ADC_WRITE32( REG_ADC_COMP_VALUE_L, AdcTempDat );break;

        case ADC2_SEL:
            AdcTempDat  =   HAL_ADC_READ32(
  REG_ADC_COMP_VALUE_H );AdcTempDat  &=  ~(BIT_ADC_COMP_TH_2( 0xFFFF ));
            AdcTempDat  |=  BIT_CTRL_ADC_COMP_TH_2(
  pHalAdcInitData->ADCCompTD );HAL_ADC_WRITE32( REG_ADC_COMP_VALUE_H, AdcTempDat );break;

        case ADC3_SEL:
            AdcTempDat  =   HAL_ADC_READ32(
  REG_ADC_COMP_VALUE_H );AdcTempDat  &=  ~(BIT_ADC_COMP_TH_3( 0xFFFF ));
  ...
  pHalAdcInitData->ADCCompTD );HAL_ADC_WRITE32( REG_ADC_COMP_VALUE_H, AdcTempDat );break;
    ...
    AdcTempDat  =   HAL_ADC_READ32(
  REG_ADC_COMP_SET );AdcTempDat  &=  (~(0x01 << pHalAdcInitData->ADCIdx));
    AdcTempDat  |=  (BIT_CTRL_ADC_COMP_0_EN( pHalAdcInitData->ADCCompCtrl )<<
                                                    pHalAdcInitData->ADCIdx);
    HAL_ADC_WRITE32(
  REG_ADC_COMP_SET, AdcTempDat );

/* ADC audio mode set-up */
AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );AdcTempDat  &=  ~(BIT_ADC_AUDIO_EN);
    AdcTempDat  |=  BIT_CTRL_ADC_AUDIO_EN( pHalAdcInitData->ADCAudioEn );HAL_ADC_WRITE32(
  REG_ADC_ANAPAR_AD0, AdcTempDat );

/* ADC enable manually setting */
AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );AdcTempDat  &=  ~(BIT_ADC_EN_MANUAL);
    AdcTempDat  |=  BIT_CTRL_ADC_EN_MANUAL( pHalAdcInitData->ADCEnManul );HAL_ADC_WRITE32(
  REG_ADC_ANAPAR_AD0, AdcTempDat );

/* ADC analog parameter 0 */
AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("AD0:%x\n", AdcTempDat);
    //AdcTempDat  |= (BIT0);
    ...
    HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD0, AdcTempDat );AdcTempDat  =   HAL_ADC_READ32(
  REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("AD0:%x\n", AdcTempDat);

    /* ADC analog parameter 1 */
    AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD1 );AdcTempDat  &= (~BIT1);
    AdcTempDat  |= (BIT2|BIT0);
    HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD1,
  AdcTempDat );AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("AD1:%x\n", AdcTempDat);

    /* ADC analog parameter 2 */
    AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD2 );DBG_ADC_INFO("AD2:%x\n", AdcTempDat);
    AdcTempDat  = 0x67884400;
    HAL_ADC_WRITE32(
  REG_ADC_ANAPAR_AD2, AdcTempDat );AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD2 );DBG_ADC_INFO("AD2:%x\n", AdcTempDat);

    /* ADC analog parameter 3 */
    AdcTempDat  =   HAL_ADC_READ32(
  REG_ADC_ANAPAR_AD3 );DBG_ADC_INFO("AD3:%x\n", AdcTempDat);
    AdcTempDat  =  0x77780039;
    HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD3, AdcTempDat );AdcTempDat  =   HAL_ADC_READ32(
  REG_ADC_ANAPAR_AD3 );DBG_ADC_INFO("AD3:%x\n", AdcTempDat);

    /* ADC analog parameter 4 */
    AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD4 );DBG_ADC_INFO("AD4:%x\n", AdcTempDat);
    AdcTempDat  =  0x0004d501;
    HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD4,
  AdcTempDat );AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD4 );DBG_ADC_INFO("AD4:%x\n", AdcTempDat);

    /* ADC analog parameter 5 */
    AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD5 );DBG_ADC_INFO("AD5:%x\n", AdcTempDat);
    AdcTempDat  =  0x1E010800;
    HAL_ADC_WRITE32(
  REG_ADC_ANAPAR_AD5, AdcTempDat );AdcTempDat  =   HAL_ADC_READ32( REG_ADC_ANAPAR_AD5 ); DBG_ADC_INFO("AD5:%x\n", AdcTempDat);
...
)
{
    ...
    AdcTempDat      =   HAL_ADC_READ32( REG_ADC_POWER );AdcTempDat      &=  ~(BIT_ADC_PWR_AUTO);
    HAL_ADC_WRITE32( REG_ADC_POWER, AdcTempDat );
...
AdcTempDat      &=  (~BIT_ADC_PWR_AUTO);
    AdcTempDat      |= 0x02;
    HAL_ADC_WRITE32( REG_ADC_POWER, AdcTempDat );AdcTempDat      |= 0x04;
    HAL_ADC_WRITE32( REG_ADC_POWER, AdcTempDat );AdcTempDat      &= (~0x08);
    HAL_ADC_WRITE32(
REG_ADC_POWER, AdcTempDat );

AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_POWER ); DBG_ADC_INFO("HalADCEnableRtl8195a, power reg:%x\n",AdcTempDat);
return _EXIT_SUCCESS;
}
...
HalADCReadRegRtl8195a(
    ...
    AdcTempDat  =   HAL_ADC_READ32( I2CReg ); return (AdcTempDat);
}
...
.ADCIdx = 0, .ADCEn = 0, .ADCEndian = 0, .ADCBurstSz = 0, .ADCCompOnly = 0, .ADCOneShotEn = 0,
.ADCOverWREn = 0, .ADCOneShotTD = 0, .ADCCompCtrl = 0, .ADCCompTD = 0, .ADCDataRate = 0,
.ADCAudioEn = 0, .ADCEnManul = 0, .ADCDbgSel = 0, .RSVD0 = 0, .ADCData = (u32 *) NULL, .ADCPWCtrl =
0, .ADCIntrMSK = 0 };
...
ADCISRHandle(
    ...
    if (pSalADCHND->OpType == ADC_RDREG_TYPE){
        ADCFullStsFlag = 1;
        ADCDatBuf[0]    = (u32)HAL_ADC_READ32( REG_ADC_FIFO_READ );ADCDatBuf[1]    = (u32)HAL_ADC_READ32( REG_ADC_FIFO_READ ); pSalADCHND->pInitDat->ADCIntrMSK = 0;
...
HalGdmaOpInit(pHALADCGdmaOp);
        ...
        AdcTempDat  =   HAL_ADC_READ32( REG_ADC_POWER );AdcTempDat  |=  BIT_ADC_PWR_AUTO;
        HAL_ADC_WRITE32( REG_ADC_POWER, AdcTempDat ); return _EXIT_SUCCESS;
}
return _EXIT_FAILURE;
}
...
RtkADCReceiveBuf(
    ...
    /* Clear ADC Status */
	//HAL_ADC_READ32(REG_ADC_INTR_STS);
	AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_INTR_STS );DBG_ADC_INFO("RtkADCReceiveBuf, INTR:%x\n", AdcTempDat);
	...
	AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_POWER );if (unlikely((AdcTempDat & 0x00000008) == 0)) {
		;
	}
	else {
    ...
    pHalADCOP->HalADCIntrCtrl(pSalADCHND->pInitDat);
	pSalADCHND->DevSts = ADC_STS_IDLE;
	AdcTempDat  = (u32)HAL_ADC_READ32(
REG_ADC_ANAPAR_AD0 );

if ((AdcTempDat & 0x00000001) == 0){
        AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCReceiveBuf, Before set, Reg AD1:%x\n", AdcTempDat);
		AdcTempDat |= (0x01);
		HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD1, AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32(
REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCReceiveBuf, After set, Reg AD1:%x\n", AdcTempDat);

		AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCReceiveBuf, Before set, Reg AD0:%x\n", AdcTempDat);
		AdcTempDat |= (0x01);
		HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD0,
AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCReceiveBuf, After set, Reg AD0:%x\n", AdcTempDat);
	}
	else{
		;
	}
	...
	AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCReceiveBuf, End of ADC, Before set, AD0:%x\n", AdcTempDat);
	AdcTempDat &= (~0x01);
	HAL_ADC_WRITE32(
REG_ADC_ANAPAR_AD0, AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCReceiveBuf, End of ADC, After set, AD0:%x\n", AdcTempDat);

	AdcTempDat  = (u32)HAL_ADC_READ32(
REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCReceiveBuf, End of ADC, Before set, AD1:%x\n", AdcTempDat);
	AdcTempDat &= (~0x01);
	HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD1, AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32(
REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCReceiveBuf, End of ADC, After set, AD1:%x\n", AdcTempDat);

    /* Clear ADC Status */
	HAL_ADC_READ32( REG_ADC_INTR_STS ); ADCFullStsFlag = 0;
...
RtkADCRxManualRotate(
    ...
    /* Clear ADC Status */
	AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_INTR_STS );DBG_ADC_INFO("RtkADCRxManualRotate, INTR:%x\n", AdcTempDat);
...
if ((AdcTempDat & 0x00000001) == 0){
        AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCRxManualRotate, Before set, Reg AD1:%x\n", AdcTempDat);
		...
		*/
		...
		HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD1, AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32(
REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCRxManualRotate, After set, Reg AD1:%x\n", AdcTempDat);
		//DBG_8195A("1. Reg AD1:%x\n", AdcTempDat);

		AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCRxManualRotate, Before set, Reg AD0:%x\n", AdcTempDat);
		AdcTempDat |= (0x01);
		HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD0,
AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCRxManualRotate, After set, Reg AD0:%x\n", AdcTempDat);
	}
	else{
		;
	}
    ...
    AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD1 );AdcTempDat &= ~(BIT7|BIT5|BIT4|BIT3|BIT2|BIT1);
    AdcTempDat |= (BIT1);
	HAL_ADC_WRITE32(
REG_ADC_ANAPAR_AD1, AdcTempDat );HalDelayUs(500);
...
REG_ADC_ANAPAR_AD1, AdcTempDat );HalDelayUs(500);
    ...
    /* Close ADC */
    AdcTempDat  = (u32)HAL_ADC_READ32(
REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCRxManualRotate, End of ADC, Before set, AD0:%x\n", AdcTempDat);
    AdcTempDat &= (~0x01);
    HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD0, AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32(
REG_ADC_ANAPAR_AD0 );DBG_ADC_INFO("RtkADCRxManualRotate, End of ADC, After set, AD0:%x\n", AdcTempDat);

    AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCRxManualRotate, End of ADC, Before set, AD1:%x\n", AdcTempDat);
    AdcTempDat &= (~0x01);
    HAL_ADC_WRITE32( REG_ADC_ANAPAR_AD1,
AdcTempDat );AdcTempDat  = (u32)HAL_ADC_READ32( REG_ADC_ANAPAR_AD1 );DBG_ADC_INFO("RtkADCRxManualRotate, End of ADC, After set, AD1:%x\n", AdcTempDat);
