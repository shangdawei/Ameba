...
VOID WDGIrqHandle( IN VOID *Data )
{
  u32 temp;
  WDG_REG *CtrlReg;
...
VOID WDGIrqCallBackReg( IN VOID *CallBack, IN u32 Id )
{
...
VOID WDGGtimerHandle( IN VOID *Data )
{
  u32 *Temp = (u32*) &( WDGAdapter.Ctrl );
  WDGAdapter.Ctrl.WdgClear = 1;
  DBG_8195A( "reset WDG\n" );
