#ifndef __RTL8195AM_SPIC_H__
#define __RTL8195AM_SPIC_H__
...
#if ( CONFIG_IMAGE_SEPARATE == 0 )          // Store SPIC Calibration only for seprated image
...
_LONG_CALL_ extern VOID SpicLoadInitParaFromClockRtl8195A( u8 CpuClkMode, u8 BaudRate,
...
_LONG_CALL_ROM_ VOID SpicLoadInitParaFromClockRtl8195AV02( IN u8 CpuClkMode, IN u8 BaudRate,
...
VOID SpicUserProgramRtl8195A( IN u8 * data, IN SPIC_INIT_PARA SpicInitPara, IN u32 addr,
  IN u32 * LengthInfo );
...
VOID
SpicTxCmdWithDataRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u8 cmd, IN u8 DataPhaseLen,
  IN u8* pData );

VOID
SpicTxFlashInstRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u8 cmd, IN u8 DataPhaseLen,
  IN u8* pData );

VOID
SpicDeepPowerDownFlashRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara );

VOID
SpicBlockEraseFlashRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u32 Address );

VOID
SpicSectorEraseFlashRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u32 Address );

VOID
SpicWriteProtectFlashRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u32 Protect );

BOOLEAN
SpicFlashInitRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u8 SpicBitMode );

u32
SpicCalibrationRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u8 SpicBitMode,
  IN u32 DefRdDummyCycle );

VOID
SpicConfigAutoModeRtl8195A_V04( IN u8 SpicBitMode );

VOID
SpicWaitWipDoneRefinedRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara );

VOID
SpicRxCmdRefinedRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u8 cmd );

u8
SpicGetFlashStatusRefinedRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara );

VOID
SpicInitRefinedRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u8 InitBaudRate,
  IN u8 SpicBitMode );

VOID
SpicEraseFlashRefinedRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara );

VOID
SpicSetFlashStatusRefinedRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u32 data );

u32
SpicWaitWipRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara );

u32
SpicOneBitCalibrationRtl8195A_V04( IN SPIC_INIT_PARA *pSpicInitPara, IN u8 SysCpuClk );

VOID
SpicLoadInitParaFromClockRtl8195A_V04( IN u8 CpuClkMode, IN u8 BaudRate,
  IN PSPIC_INIT_PARA pSpicInitPara );
...
VOID
SpicUserProgramRtl8195A_V04( IN u8 * data, IN SPIC_INIT_PARA SpicInitPara, IN u32 addr,
  IN u32 * LengthInfo );
